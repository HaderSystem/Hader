...
import 'package:flutter_screenutil/flutter_screenutil.dart'; // ✅ تم إضافته
...
import 'package:flutter_application_2/views/teacher/teacher_dashboard_view.dart';
  ...
  runApp(
    EasyLocalization(
      ...
      child: ScreenUtilInit(
        designSize: Size(390, 844), // ✅ الحجم القياسي لتناسب Android
        minTextAdapt: true,
              ...
              return MaterialApp(
               ...
               // useInheritedMediaQuery: true, 
                ...
                routes: {
                  ...
                  '/teacher': (context) => const TeacherDashboardView(),
